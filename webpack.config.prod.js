...
const API_ROOT = 'https://fyk4q76qu1.execute-api.us-east-1.amazonaws.com'; // CHANGE THIS TO MATCH THE URL OF YOUR API GATEWAY API OR YOUR CUSTOM DOMAIN FOR API
