...
const API_ROOT = 'https://db79r5ahb5.execute-api.us-east-1.amazonaws.com'; // CHANGE THIS TO MATCH THE URL OF YOUR API GATEWAY API OR YOUR CUSTOM DOMAIN FOR API
